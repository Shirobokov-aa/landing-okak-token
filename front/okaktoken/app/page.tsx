...
export default function OkakCatLanding() {
  ...
  return (
    <>
      <Head>
        <title>OKAK | OkakCat | Solana Meme Token</title>
        <meta name="description" content="OKAK — мем-токен на Solana. Присоединяйся к самой пушистой революции в DeFi! $OKAK — мемы, комьюнити, moonshot!" />
        <meta name="keywords" content="OKAK, OkakCat, Solana, meme token, криптовалюта, мемкоин, DeFi, токен, коты, крипта, solana meme" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="OKAK | OkakCat | Solana Meme Token" />
        <meta property="og:description" content="OKAK — мем-токен на Solana. Присоединяйся к самой пушистой революции в DeFi! $OKAK — мемы, комьюнити, moonshot!" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://okak.cat/" />
        <meta property="og:image" content="/images/logo.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="OKAK | OkakCat | Solana Meme Token" />
        <meta name="twitter:description" content="OKAK — мем-токен на Solana. Присоединяйся к самой пушистой революции в DeFi! $OKAK — мемы, комьюнити, moonshot!" />
        <meta name="twitter:image" content="/images/logo.png" />
        <link rel="canonical" href="https://okak.cat/" />
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{
          ...
          "name": "OKAK | OkakCat",
          "url": "https://okak.cat/",
          "logo": "https://okak.cat/images/logo.png",
          "sameAs": [
            "https://x.com/1k_airdroptoken",
            "https://t.me/airdroptoken_1k"
          ]
        }` }} />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{
          "@context": "https://schema.org",
          "@type": "Product",
          "name": "OKAK Token",
          "description": "Solana meme token $OKAK",
          "brand": {
            "@type": "Brand",
            "name": "OkakCat"
          },
          "url": "https://okak.cat/",
          "image": "https://okak.cat/images/logo.png"
        }` }} />
      </Head>
            ...
            <div className="flex items-center space-x-2">
              <div className="w-14 h-14 border-[1px] border-white rounded-full flex items-center justify-center">
                <span className="text-white font-bold text-lg">
                  <Image src="/images/logo.png" alt="Логотип OkakCat" width={54} height={54} className="rounded-full" />
                </span>
              </div>
            ...
            <div className="mb-8">
              ...
              >
                <span className="text-6xl">
                  <Image src="/images/logo.png" alt="Логотип OkakCat" width={150} height={150} className="rounded-full" />
                </span>
              </motion.div>
        ...
        <footer className="py-12 px-4 bg-gray-900 text-white border-t border-gray-800">
          <div className="container mx-auto">
              ...
              <div className="flex items-center space-x-2 mb-4 md:mb-0">
                <div className="w-8 h-8 bg-gradient-to-br from-orange-500 to-pink-600 rounded-full flex items-center justify-center">
                  <span className="text-white text-sm">
                    <Image src="/images/logo.png" alt="Логотип OkakCat" width={32} height={32} className="rounded-full" />
                  </span>
                </div>
                <span className="font-bold text-xl">OKAK | OkakCat | Solana</span>
              </div>
            ...
            <div className="text-center text-gray-400">
              <p>&copy; 2025 OKAK | OkakCat | Solana. All rights reserved. This is a meme token for entertainment purposes.</p>
